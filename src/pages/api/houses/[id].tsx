...
const getHouse = withSessionRoute(async (req: NextApiRequest, res: NextApiResponse) => {
	try {
...
const postBid = withSessionRoute(async (req: NextApiRequest, res: NextApiResponse) => {
	try {
