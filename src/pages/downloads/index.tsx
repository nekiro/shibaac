      ...
      <Panel header="Downloads">
        <div className="col-lg-4">
          <div className="downloads__title">
            ...
            <p>
              we bring the best customer in the community, with a very low fps,
              minimum level of debugs, always focusing on improvements.
            </p>
          </div>
            ...
            <div className="row">
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="downloads__item">
                  ...
                  <p>
                    Memory: 4GB RAM Graphics: 128MB; if DirectX 9c or OpenGL 2.1
                    are not supported, only software renderer mode is available
                    (no light effects)
                  </p>
